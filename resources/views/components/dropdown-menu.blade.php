<el-dropdown class="inline-block cursor-pointer">
        ...
        <div class="py-1">
            ...
            @if(auth()->user()->subscribed())
                ...
                <a href="{{route("subscription.manage")}}"
                   class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:text-gray-900 focus:outline-hidden dark:text-gray-300 dark:focus:bg-white/5 dark:focus:text-white">Mi
                    Suscripcion</a>
            @endif
